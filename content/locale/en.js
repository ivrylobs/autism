export const en = {
  "/": {
    ...
    about1: "Autism Research and Service Institute Office of the President Khon Kaen University was approved in accordance with the order of the Prime Minister. General Prayut Chan-o-cha, as of June 21, 2017, is the university's mission and strategy support agency. Khon Kaen to take care of people with autism",
    team: "Our team",
    team1: "To provide services to people with autism to receive services that are comprehensive and comprehensive in all aspects.",
    team2: "Advisor",
  ...
  "/works/research":{
    ...
    projectreseach2:"The Development of Teachers Potentiality by Using Intensive Assisting Program to Enhance Academic and Social Skills of Person with Autism Spectrum Disorder is a developmental research to create a program for teachers to integrate into the teaching of elementary school children with autism spectrum disorder to enhance their academic and social skills. (Inventor: Assoc.Prof.Dr.Piyawan Srisurak)",
    projectreseach3:"Developing Academic and Language Skills for Students with Autism Spectrum Disorder in Inclusive and Parallel Classrooms is a developmental research to create a program for teachers to integrate into teaching kindergarten children with autism spectrum disorder to enhance academic and language skills (Inventor: Mrs. Pornmanee Hanhak)",
    projectreseach4:"The Development of Program for Family to Enhance Social Skills of Person with Autism Spectrum Disorder is a developmental research to make a program for parents or guardians to use to improve social skills in homes with autism spectrum disorder. (Inventor: Dr. Thirakorn Maneerat)",
  },
  "/works/research/active":{
    ...
    researchactive1:"1. Development of a daily routine training program including utilizing of a sample room for kindergarten students with autism spectrum and their families (HCP)",
    researchactive11:"(Dr. Kornwan Mongkut)",
    researchactive2:"2. Curriculum development includes 5 basic skills in Kindergarten learners with autism spectrum",
    researchactive22:"(Asst. Prof. Dr. Piyawan Srisurak)",
    researchactive222:"2.1 Integrated curriculum to develop cognitive skills for students with autism spectrum in kindergarten level. (Asst. Prof. Dr. Piyawan Srisurak)",
    researchactive2222:"2.2 A curriculum for developing language perception and expression skills for preschool children with autism spectrum in the combined classroom (Lecture. Araporn Trisun)",
    researchactive22222:"2.3 A curriculum for Physical fitness enhancement course for kindergarten students with autism spectrum in co-learning schools (Lecture. Wanchai Chantakarnkun)",
    researchactive222222:"2.4 A inclusive curriculum to develop self-help skills in routine practice in Kindergarten students. With autism spectrum conditions (Lecture. Charoen Kwan Sripanchat)",
    researchactive2222222:"2.5 A combined curriculum for developing social skills of Kindergarten students with autism spectrum conditions (Lecture. Pornmanee Hanhak)",
    researchactive3:"3. Homework skills training program for people with autism, a group of teenagers who do not have spoken language ",
    ...
    researchactive5:"5. Curriculum development, planning and organizing for occupation in adolescents Autism spectrum",
    researchactive55:"(Dr. Benjamaporn Choikru)",
    researchactive6:"6. Changes in cerebral glucose metabolism as assessed by FDG Pet CT in autistic patients after stimulation by DC electric through skull",
  ...
  "/works/service":{
    ...
    service2:"2. Assistance to persons with autism spectrum in the combined classroom at The Demonstration School of Khon Kaen University Mor Din Daeng Special Education Department.",
  }
};
