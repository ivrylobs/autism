        ...
        <Container maxWidth="xl" className={classes.Container}>
          <Grid container>
            <Grid item xs={12} className={classes.BgContainer}>
              <img src="/news9.jpeg" alt="news9" className={classes.BgNews} />
            </Grid>
            <Grid item sm={7} md={8} className={classes.gridItem1}>
                <Typography variant="h4" className={classes.Typography1}>
                สถาบันวิจัยและบริการด้านออทิซึมขอแสดงความยินดีกับ
              ท่านรักษาการผู้อำนวยการที่ได้รับการแต่งตั้งให้ดำรงตำแหน่ง
              รองศาสตราจารย์ ดร.ปิยะวรรณ ศรีสุรักษ์
                ...
                <Box>
                  ...
                  >
                   สถาบันวิจัยและบริการด้านออทิซึมขอแสดงความยินดีกับท่านรักษาการผู้อำนวยการที่ได้รับการแต่งตั้งให้ดำรงตำแหน่ง รองศาสตราจารย์ ดร.ปิยะวรรณ ศรีสุรักษ์
                  </Typography>
                </Box>
            </Grid>
