              ...
              <Grid item sm={7} md={8} className={classes.gridItem1}>
                ...
                <Box>
                  <Typography variant="subtitle1" className={classes.bgBox}>
                    ...
                    ผู้ปกครองควรพูดคุยเกี่ยวกับโรค COVID-19 เพื่อให้แน่ใจว่าเด็ก
                    ๆ รู้เรื่องที่จำเป็นโดยที่ไม่เกิดความกังวลโดยใช่เหตุ
                    1.ให้ข้อมูลที่เหมาะสมกับอายุและระดับความเข้าใจของเด็กด้วยตนเอง
                    2.สอนด้วยวิธีที่เด็กสนใจ เช่น ใช้ภาพหรือนิทานประกอบ
                    3.เด็กๆอาจมีการเล่นหรือพูดถึงเรื่องที่น่ากลัว
                    ซึ่งเป็นกระบวนการทำความเข้าใจข้อมูล
                    ผู้ปกครองควรทำให้รู้สึกมั่นใจและคอยตอบคำถามพวกเขาได้
                    4.คอยติดตามและสื่อสารข้อมูลกับครู พี่เลี้ยง ผู้ดูแล
                    5.คอยสังเกตการเปลี่ยนแปลงที่เกิดขึ้น
                    อาจต้องการความช่วยเหลือหากมีความเครียดหรือกังวล
                    6.คอยเป็นที่ปรึกษาสร้างความมั่นใจให้เด็กรู้สึกปลอดภัย ที่มา:
                    กรมสุขภาพจิต กระทรวงสาธารณสุข ข้อมูล:
