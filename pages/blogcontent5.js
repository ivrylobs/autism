        ...
        <Container maxWidth="xl" className={classes.Container}>
          <Grid container>
            <Grid item xs={12} className={classes.BgContainer}>
              <img src="/news5.jpeg" alt="news5" className={classes.BgNews} />
            </Grid>
            <Grid item sm={7} md={8} className={classes.gridItem1}>
              ...
              ที่เข้ารับพระราชทานตำแหน่ง ศาสตราจารย์เกียรติคุณ 13 ธันวาคม 2563
                ...
                <Box>
                  ...
                  >
                   สถาบันวิจัยและบริการด้วนออทิซึม ขอแสดงความยินดีกับท่านที่ปรึกษา ที่เข้ารับพระราชทานตำแหน่ง ศาสตราจารย์เกียรติคุณ 13 ธันวาคม 2563
                  </Typography>
                </Box>
            </Grid>
