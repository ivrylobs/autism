            ...
            <Grid container>
              ...
              <Grid item sm={7} md={8} className={classes.gridItem1}>
                <Typography variant="h4" className={classes.Typography1}>
                  ...
                  เข้าตรวจเยี่ยมสถาบันวิจัยและบริการด้านออทิซึม
                  เพื่อพิจารณาให้ใบอนุญาตจัดตั้งศูนย์บริการคนพิการทั่วไปของจังหวัดขอนแก่น
                </Typography>
                ...
                <Box>
                  <Typography variant="subtitle1" className={classes.bgBox}>
                    ...
                    สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดขอนแก่นเข้าตรวจเยี่ยมสถาบันวิจัยและบริการด้านออทิซึม
                    เพื่อพิจารณาให้ใบอนุญาตจัดตั้งศูนย์บริการคนพิการทั่วไปของจังหวัดขอนแก่น
                  </Typography>
                </Box>
              </Grid>
