          ...
          <Container maxWidth="xl" className={classes.Container}>
            <Grid container>
              <Grid item xs={12} className={classes.BgContainer}>
                <img src="/news2.jpeg" alt="news2" className={classes.BgNews} />
              </Grid>
              <Grid item sm={7} md={8} className={classes.gridItem1}>
                ...
                <Box>
                  <Typography variant="subtitle1" className={classes.bgBox}>
                    คณะผู้ตรวจสอบภายใน กองตรวจสอบภายใน สำนักงานอธิการบดี
                    เข้าตรวจสอบหน่วยงาน เพื่อแจ้งขอบเขตการตรวจสอบประจำปีงบประมาณ
                    2564
                    และเพื่อให้การปฏิบัติเป็นไปตามนโยบายรัฐบาลและตามประกาศที่มหาวิทยาลัยกำหนด
                  </Typography>
                </Box>
              </Grid>
