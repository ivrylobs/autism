          ...
          <Container maxWidth="xl" className={classes.Container}>
            <Grid container>
              <Grid item xs={12} className={classes.BgContainer}>
                <img src="/news7.jpeg" alt="news7" className={classes.BgNews} />
              </Grid>
              <Grid item sm={7} md={8} className={classes.gridItem1}>
                <Typography variant="h4" className={classes.Typography1}>
                  สถาบันวิจัยและบริการด้านออทิซึมมีการประชุมทีมงานการพัฒนาการวิจัยด้าน
                ...
                <Box>
                  <Typography variant="subtitle1" className={classes.bgBox}>
                    สถาบันวิจัยและบริการด้านออทิซึมมีการประชุมทีมงานการพัฒนาการวิจัยด้าน
                    AI Chatbot (Artificial Intelligence Chatbot) เมื่อวันที่ 3
                    ธันวาคม 2563
                    โดยมีผู้เชี่ยวชาญและ￼￼ผู้ทรงคุณวุฒิเข้าร่วมนำเสนอแนวคิดในการจัดทำโครงการวิจัย￼ดังกล่าว
                  </Typography>
                </Box>
              </Grid>
