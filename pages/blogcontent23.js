        ...
        <Container maxWidth="xl" className={classes.Container}>
          <Grid container>
            <Grid item xs={12} className={classes.BgContainer}>
              <img src="/news23.jpeg" alt="news23" className={classes.BgNews} />
            </Grid>
            <Grid item sm={7} md={8} className={classes.gridItem1}>
                ...
                <Box>
                  ...
                  >
                     ได้จัดการประชุมคณะกรรมการดำเนินงานเพื่อรายงานผลการดำเนิน
              งานที่ผ่านมา ความก้าวหน้าในการดำเนินโครงการวิจัย
              และวางแผนแนวทางการดำเนินงานร่วมกัน
                  </Typography>
                </Box>
            </Grid>
