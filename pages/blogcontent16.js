            ...
            <Grid container>
              ...
              <Grid item sm={7} md={8} className={classes.gridItem1}>
                <Typography variant="h4" className={classes.Typography1}>
                  ...
                  Microsoft Team เรื่อง “Teaching and learning in New Normal for
                  Education”
                </Typography>
                ...
                <Box>
                  <Typography variant="subtitle1" className={classes.bgBox}>
                    นักวิจัยฝ่ายสังคม
                    ได้ประชุมคณะนักวิจัยโครงการเกษตรเพื่อบุคคลออทิซึมสเปกตรัม
                    เมื่อวันอังคารที่ 12 พฤษภาคม 2563
                    มีผู้เชี่ยวชาญเข้าร่วมให้ข้อเสนอแนะที่เป็นประโยชน์ในการดำเนินงานโครงการเป็นอย่างดี
                  </Typography>
                </Box>
              </Grid>
