        ...
        <CardActionArea>
          ...
          <CardContent className={classes.PaddingText}>
            ...
            <Typography variant="subtitle1" className={classes.Typo2}>
              สถาบันวิจัยและบริการด้านออทิซึมจัดกิจกรรมลานเพลิน ภายใต้โครงการ
              โครงการศูนย์การเรียนรู้เพื่อบุคคลออทิสติกตามแนวเศรษฐกิจพอเพียง ณ
              ศูนย์การเรียนรู้เกษตรผสมผสาน บ้านโนนกู่ ต.สาวะถี อ.เมือง จ.ขอนแก่น
            </Typography>
          </CardContent>
        </CardActionArea>
      </Card>
