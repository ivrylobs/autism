					...
					<Container maxWidth="xl" className={classes.BlogContainer}>
						<Grid container className={classes.CarditemAbotus}>
							<Grid item xs={12} sm={6} md={5} lg={5} xl={5}>
								...
								<br></br>
								<div>
									<Typography className={classes.WorkTypo3}>{f("researchwork1")}</Typography>
								</div>
							</Grid>

							<Grid item xs={12} sm={6} md={7} lg={7} xl={7}>
								<img src="/ourwork2.png" alt="work1" className={classes.multiImg} />
							</Grid>
							<Grid item xs={12}>
							<br></br>
								<div className={classes.BTalign}>
									<Button component={Link} href="/works/research" variant="contained" size="large" className={classes.buttonMore}>
										{f("button")}
									</Button>
								</div>
							</Grid>
